...
const puerto = '17027';       // puerto del servidor mongoDB
const db = 'nodepop';         // nombre de la base de datos
const usr = 'mongoUser';     // usuario de la conexion
const pwd = 'K33pcoding2017'; //contraseña conexion
const cadenaConexion = 'mongodb://'+usr+':'+pwd+'@'+host+':'+puerto+'/'+db;
let noIndex = {};
